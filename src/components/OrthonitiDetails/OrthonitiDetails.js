...
const OrthonitiDetails = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/krishiOrthoniti/${id}`).then((res) => {
      setData(res.data);
      console.log(res.data);
    });
    axios.get("http://localhost:5000/krishiOrthonit/all").then((res) => {
      setAllData(res.data);
      console.log(res.data);
    });
  }, [id]);
...
export default OrthonitiDetails;
